...
![XAUUSD Chart](https://github.com/algorembrant/Pinescript.TradingView-Indicators.and.Strategies/blob/main/Pinescript%20Language/Indicators/89RS.Rangebreakout-Stoporder/Screenshot%202025-11-12%20144500.png)
...
Now that the framework is done, lets automate the process when getting the statistical rersults to avoid stressful manual labor. We will now move on to the *Strategy* version of this **89RS** Indicator
